...
Route::middleware('ensure.web.admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::delete('/monthly-profits/{monthlyProfit}', [AdminActionsController::class, 'destroyMonthlyProfit'])->name('monthly-profits.destroy');
    ...
    Route::delete('/settlements/{settlement}', [AdminActionsController::class, 'destroySettlement'])->name('settlements.destroy');
    ...
    Route::delete('/funds/{fund}/transactions/{fundTransaction}', [AdminActionsController::class, 'destroyFundTransaction'])->name('funds.transactions.destroy');
